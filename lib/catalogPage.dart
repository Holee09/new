                ...
                children: [
                  Row(
                      children: [
                        ...
                        TextButton(
                            onPressed: (){
                              context.read<variable.StoreAboutData>().nameLabs();
                              context.read<variable.StoreAboutTab>().goLabs();
                              showDialog(
                                  context: context,
                                  builder: (context){ return SetLabsChapter(); }
                              );
                            },
                            child: Text('연구실')
                        )
                  ...
                  Row(
                      children: [
                        ...
                        TextButton(
                            onPressed: (){
                              context.read<variable.StoreAboutData>().nameClubs();
                              context.read<variable.StoreAboutTab>().goClubs();
                              showDialog(
                                  context: context,
                                  builder: (context){ return SetClubsChapter(); }
                              );
                            },
                            child: Text('동아리')
                        )
...
class SetLabsChapter extends StatelessWidget {
  const SetLabsChapter({Key? key}) : super(key: key);
...
class SetClubsChapter extends StatelessWidget {
  const SetClubsChapter({Key? key}) : super(key: key);
